...
agent = DQNAgent.DQNAgent(action_type=action, batch_size=128, model_type=6, success_margin=100, success_score=-110,
                          record_video=False, target_model=True, memory_size=None, algorithm="dqn",
